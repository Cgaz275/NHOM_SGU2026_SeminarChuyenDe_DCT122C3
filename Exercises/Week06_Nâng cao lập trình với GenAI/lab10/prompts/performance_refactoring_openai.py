...
from ch10.app import calculate_distance
...
CODE:
[Insert only the Python code here]

EXPLANATION:
[1. Explain how the new code works. 
 2. Crucially, you must explicitly state the TECHNICAL REASONS why it improves performance]"""
...
if __name__ == "__main__":
    ...
    user_prompt = get_user_prompt(calculate_distance, "NumPy", LINES)
