...
let mockUsers: AdminUser[] = [
  ...
  { id: '7', accountId: 'ACC-007', fullName: 'Mina Tran', email: 'mina.tran@gmail.com', registeredAt: '2026-01-12T13:10:00Z', status: 'verified' },
  { id: '8', accountId: 'ACC-008', fullName: 'An Nguyen', email: 'an.nguyen@gmail.com', registeredAt: '2026-01-18T15:00:00Z', status: 'verified' },
  { id: '9', accountId: 'ACC-009', fullName: 'Bao Pham', email: 'bao.pham@gmail.com', registeredAt: '2026-02-02T10:30:00Z', status: 'locked' },
  { id: '10', accountId: 'ACC-010', fullName: 'Linh Vo', email: 'linh.vo@gmail.com', registeredAt: '2026-02-14T09:40:00Z', status: 'verified' },
];

let mockReports: AdminReport[] = [
  { id: '1', accountId: 'ACC-003', fullName: 'Ace Foley', email: 'ace.fo@yahoo.com', accountStatus: 'locked', reason: 'Quấy rối', createdAt: '2026-03-01T10:00:00Z', reportStatus: 'pending' },
  { id: '2', accountId: 'ACC-004', fullName: 'Nikolai Schmidt', email: 'nikolai.schmidt1964@outlook.com', accountStatus: 'locked', reason: 'Nội dung không phù hợp', createdAt: '2026-03-02T11:20:00Z', reportStatus: 'resolved' },
  { id: '3', accountId: 'ACC-007', fullName: 'Mina Tran', email: 'mina.tran@gmail.com', accountStatus: 'verified', reason: 'Tài khoản giả mạo', createdAt: '2026-03-05T14:15:00Z', reportStatus: 'pending' },
  { id: '4', accountId: 'ACC-009', fullName: 'Bao Pham', email: 'bao.pham@gmail.com', accountStatus: 'locked', reason: 'Vi phạm điều khoản', createdAt: '2026-03-10T09:30:00Z', reportStatus: 'pending' },
  { id: '5', accountId: 'ACC-002', fullName: 'Jaiden Nixon', email: 'jaiden.n@gmail.com', accountStatus: 'verified', reason: 'Tên tài khoản không hợp lệ', createdAt: '2026-03-12T16:00:00Z', reportStatus: 'resolved' },
  { id: '6', accountId: 'ACC-001', fullName: 'Alyvia Kelley', email: 'a.kelley@gmail.com', accountStatus: 'verified', reason: 'Nội dung bạo lực', createdAt: '2026-03-15T08:45:00Z', reportStatus: 'pending' },
  { id: '7', accountId: 'ACC-008', fullName: 'An Nguyen', email: 'an.nguyen@gmail.com', accountStatus: 'verified', reason: 'Quấy rối', createdAt: '2026-03-20T11:10:00Z', reportStatus: 'resolved' },
  { id: '8', accountId: 'ACC-010', fullName: 'Linh Vo', email: 'linh.vo@gmail.com', accountStatus: 'verified', reason: 'Nội dung không phù hợp', createdAt: '2026-03-25T13:25:00Z', reportStatus: 'pending' },
];
