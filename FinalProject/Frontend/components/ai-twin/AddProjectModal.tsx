...
export function AddProjectModal({ isOpen, onClose, onAdd, initialData }: AddProjectModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title={initialData ? "Edit project" : "Add new project"} subtitle="Add a project your AI can explain.">
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input required type="text" placeholder="e.g. Jan 2022" value={startDate} onChange={e => setStartDate(e.target.value)} className="w-full bg-[#101010] border border-white/10 rounded-lg px-4 py-2 text-white focus:border-[#008FEA] focus:outline-none" />
          </div>
          <div>
