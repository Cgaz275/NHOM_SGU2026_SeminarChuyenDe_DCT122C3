...
//       <div>
//         <h2 className="text-lg font-semibold text-white">Theme & Appearance</h2>
//         <p className="text-sm text-white/50 mt-1">Customize the look of your digital card.</p>
//       </div>

//       <div className="flex flex-col gap-6">
//         {/* Theme Selection */}
//         <div className="flex flex-col gap-3">
//           <label className="text-sm font-medium text-white/90">Preset Theme</label>
