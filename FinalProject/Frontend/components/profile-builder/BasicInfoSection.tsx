  ...
  return (
    <div className="flex flex-col gap-6 bg-[#101010] border border-white/10 rounded-xl p-6">
      <div>
        ...
        <p className="text-sm text-white/50 mt-1">Set up your core personal details.</p>
      </div>
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-sm font-medium text-white/90">
              Role / Title <span className="text-[#E5484D]">*</span>
            </label>
            <input
              type="text"
              value={data.role}
        ...
        {/* Slogan */}
        <div className="flex flex-col gap-1.5">
          <label className="text-sm font-medium text-white/90">Slogan</label>
          <input
            type="text"
            value={data.slogan}
            onChange={(e) => handleTextChange('slogan', e.target.value)}
            placeholder="e.g. Designing the future of the web"
            className="bg-[#0B0B0B] border border-white/10 rounded-lg px-3 py-2.5 text-sm text-white placeholder-white/30 focus:outline-none focus:border-[#008FEA] transition-colors"
          />
        </div>
